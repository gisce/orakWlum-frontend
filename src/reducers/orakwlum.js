...
export default createReducer(initialState, {
    ...
    [CREATE_PROPOSAL_REQUEST]: (state) => Object.assign({}, state, {
        creating: true
    }),

    [CREATE_PROPOSAL_DONE]: (state) => Object.assign({}, state, {
        creating: false
    }),
